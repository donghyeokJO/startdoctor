          ...
          <div class="col-md-3">
            ...
            <div class="card card-primary card-outline" style = "transform : translate(150%,0%)">
              <div class="card-body box-profile">
                ...
                <form method="POST" action ="corp_pw_change.php">
                  <ul class="list-group list-group-unbordered mb-3">
                    <input type="hidden" id="u_id" name="u_id" value="<?=$u_id?>">
                  
                
                    <li class="list-group-item">
                      <b>변경할 비밀번호</b> <a class="float-right"><input type = "text" name = "u_pw" ></a>
                    </li>
             
                  </ul>
                  <button class="btn btn-block btn-secondary btn-sm">비밀번호 변경하기</button>
