    ...
    <section class="content">
      ...
      <div class="card">
              <div class="card-header">
                <h3 class="card-title"><?php echo $faq['f_title']?></h3>
          ...
          <!-- /.card -->
          <button class="btn btn-secondary"><a href = "faq_modify.php?f_no=<?php echo $f_no?>" style="color:#FFFFFF">수정하기</a></button>
          <button class="btn btn-danger"><a href = "faq_delete.php?f_no=<?php echo $f_no?>" style="color:#FFFFFF">삭제하기</a></button>
        </div>
