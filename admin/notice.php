    ...
    <section class="content">
      ...
      <div class="card">
            <div class="card-header">
              <h3 class="card-title">스타트 닥터 공지사항</h3>
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                <?php
                while ($row = mysqli_fetch_assoc($notice_ret)) {
                    echo "
                <tr>
                  <td>$row[n_no]</td>
                  <td><a href='notice_detail.php?n_no=$row[n_no]' style='color:#212529'>$row[n_title]</a>
                  </td>
                  <td>$row[n_date]</td>
              ...
              <div style="width:10%; margin-left:45%; margin-right:45%">
              <button type="button" class="btn btn-block btn-outline-info btn-xs"><a href="notice_write.html" style="color:#2B2B2B">글쓰기</a></button>
              </div>
            </div>
            <!-- /.card-body -->
