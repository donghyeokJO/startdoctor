<?php
  ...
  $notice_query = "select * from notice where n_no = '$n_no'";
  $notice_ret = mysqli_query($conn, $notice_query);
  $notice = mysqli_fetch_array($notice_ret);
    ...
    <section class="content">
      ...
      <div class="card">
              <div class="card-header">
                <h3 class="card-title"><?php echo $notice['n_title']?></h3>
              ...
              <div class="card-footer">
                <?php echo $notice['n_date']?>
              </div>
              <!-- /.card-footer-->
            </div>
          <!-- /.card -->
          <button class="btn btn-secondary"><a href = "notice_modify.php?n_no=<?php echo $n_no?>" style="color:#FFFFFF">수정하기</a></button>
          <button class="btn btn-danger"><a href = "notice_delete.php?n_no=<?php echo $n_no?>" style="color:#FFFFFF">삭제하기</a></button>
        </div>
