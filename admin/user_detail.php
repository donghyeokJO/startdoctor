          ...
          <div class="col-md-3">
            ...
            <div class="card card-primary card-outline" style = "transform : translate(150%,0%)">
              <div class="card-body box-profile">
                ...
                <form method = 'POST' action = "user_mod.php">
                  <ul class="list-group list-group-unbordered mb-3">
                    ...
                    <li class="list-group-item">  
                      <b>회원 구분</b> <a class="float-right"><?php echo "$user[u_specify]"?></a>
                    </li>
                    <li class="list-group-item">
                    ...
                    <li class="list-group-item">
                      <b>생년월일</b> <a class="float-right"><input type = "text" name = "u_birth" style = "border:none; text-align:right" value="<?=$user['u_birth']?>"></a>
                    </li>
                    <?php
                    if ($isbest) {
                        echo"
                    <li class=\"list-group-item\">
                      <b>의사면허 번호</b> <a class=\"float-right\">$user[u_license]</a>
                    </li>";
                    }
                    ?>
                    <li class="list-group-item">
                      <b>이용권 수</b> <a class="float-right"><?php echo "$user[u_count]"?></a>
                    </li>
                  </ul>
