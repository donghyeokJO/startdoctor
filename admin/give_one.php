<?php
  ...
  $user_query = 'select * from user where u_specify = "의사"';
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="card">
            ...
            <!-- /.card-header -->
            <div class="card-body"> 
            <form method ="POST" onsubmit ="findselected()">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>$row[u_phone]</td>
                  <td>$row[u_id]</td>
                  <td><input type = \"checkbox\" name = id[] value=\"$row[u_id]\"/></td>
              ...
              <input type ="submit" value = "1회 이용권 주기"/>
              </form>
            </div>
            <!-- /.card-body -->
          </div>
