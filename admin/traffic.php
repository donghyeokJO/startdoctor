        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="traffic.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>트래픽</p>
                </a>
              </li>
  ...
  <div class="content-wrapper">
    ...
    gapi.analytics.ready(function() {
      ...
      var mainChart = new gapi.analytics.googleCharts.DataChart({
        ...
        chart: {
          type: 'TABLE',
          container: 'pageviews-main-chart-container',
          options: {
            width: '100%'
          }
        }
      ...
      var breakdownChart = new gapi.analytics.googleCharts.DataChart({
        ...
        chart: {
          type: 'LINE',
          container: 'pageviews-breakdown-chart-container',
          options: {
            width: '100%'
          }
        }
...
gapi.analytics.ready(function() {
  ...
  var mainChart = new gapi.analytics.googleCharts.DataChart({
    ...
    chart: {
      type: 'TABLE',
      container: 'OrganicSearches-main-chart-container',
      options: {
        width: '100%t'
      }
    }
  ...
  var breakdownChart = new gapi.analytics.googleCharts.DataChart({
    ...
    chart: {
      type: 'LINE',
      container: 'OrganicSearches-breakdown-chart-container',
      options: {
        width: '100%'
      }
    }
...
<!-- Load the JavaScript API client and Sign-in library. -->
    ...
    <br>
    <div id="pageviews-main-chart-container"></div>
    <div id="pageviews-breakdown-chart-container"></div>
    <br>
    <div id="OrganicSearches-main-chart-container"></div>
    <div id="OrganicSearches-breakdown-chart-container"></div>
            <!-- /.card -->
