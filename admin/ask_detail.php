<?php
  ...
  $ask_query = "select * from ask where a_no = '$a_no'";
  $ask_ret = mysqli_query($conn, $ask_query);
  $ask = mysqli_fetch_array($ask_ret);
  $u_id = $ask['u_id'];
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="ask.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>문의사항 관리</p>
                </a>
              </li>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">문의사항</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <section class="content">
      ...
      <div class="card">
              <div class="card-header">
                <h3 class="card-title"><b>분류</b>: <?php echo $ask['a_type']?>                 |  <b >작성자</b>: <?php echo $u_name?> </h3>

              
              </div>
              <div class="card-body">
                <?php echo nl2br($ask['a_content'])?>
              </div>
              <!-- /.card-body -->
          ...
          <!-- /.card -->
          <button class="btn btn-secondary"><a href = "ask_reply.php?a_no=<?php echo $a_no?>" style="color:#FFFFFF">답변하기</a></button>
