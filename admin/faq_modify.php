<?php
  ...
  $faq_query = "select * from faq where f_no = '$f_no'";
  $faq_ret = mysqli_query($conn, $faq_query);
  $faq = mysqli_fetch_array($faq_ret);
    ...
    <section class="content">
      ...
      <div class="card">
           <div class="card-header">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" method="POST" action = "faq_modi.php">
                <div class="card-body">
                  <div class="form-group">
                    <label for="f_title">제목</label>
                    <input type="hidden" id="f_no" name="f_no" value="<?=$f_no?>">
                    <input type="text" class="form-control" id="f_title" name="f_title" value="<?=$faq['f_title']?>">
                  </div>
                  <div class="form-group">
                   <textarea id="f_content" name = "f_content" cols=200 rows=15><?php echo $faq['f_content']?></textarea>
                  </div>
                </div>
                <!-- /.card-body -->
