<?php
  ...
  $query = 'select * from user_view natural join user';
    ...
    <section class="content">
      ...
      <div class="card">
            <div class="card-header">
              <h3 class="card-title">스타트 닥터 분석시스템 조회목록</h3>
              <button type="button" class="btn btn-block btn-primary btn-sm" style ="width:20%; margin-left:80%"  onclick = "location.href='pay_view.php'">결제 내역 보기</button>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
