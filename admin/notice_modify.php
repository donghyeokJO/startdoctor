    ...
    <section class="content">
      ...
      <div class="card">
           <div class="card-header">
                <h3 class="card-title">공지사항 글쓰기</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" method="POST" action = "notice_modi.php">
                <div class="card-body">
                  <div class="form-group">
                    <label for="n_title">제목</label>
                    <input type="hidden" id="n_no" name="n_no" value="<?=$n_no?>">
                    <input type="text" class="form-control" id="n_title" name="n_title" value="<?=$notice['n_title']?>">
                  </div>
                  <div class="form-group">
                   <textarea id="n_content" name = "n_content" cols=200 rows=15><?php echo $notice['n_content']?></textarea>
                  </div>
                </div>
                <!-- /.card-body -->
