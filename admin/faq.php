    ...
    <section class="content">
      ...
      <div class="card">
            <div class="card-header">
              <h3 class="card-title">스타트 닥터 FAQ</h3>
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                <?php
                while ($row = mysqli_fetch_assoc($faq_ret)) {
                    echo "
                <tr>
                  <td>$row[f_no]</td>
                  <td><a href='faq_detail.php?f_no=$row[f_no]' style='color:#212529'>$row[f_title]</a>
                  </td>
                  <td>$row[f_date]</td>
              ...
              <button type="button" class="btn btn-block btn-outline-info btn-xs"><a href="faq_write.html" style="color:#2B2B2B">글쓰기</a></button>
              </div>
            </div>
            <!-- /.card-body -->
