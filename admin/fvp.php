        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="fvp.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>많이 방문한 페이지</p>
                </a>
              </li>
  ...
  <div class="content-wrapper">
    ...
    gapi.analytics.ready(function() {
      ...
      var mainChart = new gapi.analytics.googleCharts.DataChart({
        ...
        chart: {
          type: 'TABLE',
          container: 'avgtimeonpage-main-chart-container',
          options: {
            width: '100%'
          }
        }
      ...
      var breakdownChart = new gapi.analytics.googleCharts.DataChart({
        ...
        chart: {
          type: 'LINE',
          container: 'avgtimeonpage-breakdown-chart-container',
          options: {
            width: '100%'
          }
        }
...
<!-- Load the JavaScript API client and Sign-in library. -->
    ...
    <div id="embed-api-auth-container"></div>
    <div id="view-selector-container"></div>
    <div id="avgtimeonpage-main-chart-container"></div>
    <div id="avgtimeonpage-breakdown-chart-container"></div>
            <!-- /.card -->
