<?php
  ...
  $ask_num = mysqli_num_rows($ask_ret);
    ...
    <section class="content">
      ...
      <div class="card">
            <div class="card-header">
              <h3 class="card-title">스타트 닥터 문의사항</h3>
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                <?php
                while ($row = mysqli_fetch_assoc($ask_ret)) {
                    $name;
                    if ($row['u_id'] == 0) {
                        $name = '비회원';
                    } else {
                        ...
                        $nam = mysqli_fetch_array(r);
                        $name = $nam['u_name'];
                    }
                    echo "
                <tr>
                  <td><a href='ask_detail.php?a_no=$row[a_no]'>$row[a_no]</a></td>
                  <td>$name</td>
                  <td>$row[a_type]</td>
                  <td>$row[a_content]</td>
                  <td>$row[a_time]</td>
