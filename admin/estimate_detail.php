...
$count = mysqli_num_fields($ret);
$re = mysqli_fetch_row($ret);

$query2 = "select * from $answer where fid='$fid'";
$tmp = mysqli_query($conn, $query2);
?>
<!DOCTYPE html>
<html>
<head>
    ...
    <section class="content">
      ...
      <div class="card">
          ...
          <?php
            ...
            <div class=\"card-header\">
              <h3 class=\"card-title\">스타트 닥터</h3>
              <button type=\"button\" class=\"btn btn-block btn-primary btn-sm\" style =\"width:20%; margin-left:80%\"  onclick = \"location.href='../mypage/form_answers/$row[file]'\">견적서보기</button>
