...
(function(w, d, a){
  ...
  <div class="ploting_banner" onclick="location.href='https://pf.kakao.com/_xeIrFj'">
    ...
    <section class="back_g_l">
      <article>
        <div class="container margin_top_l">
          <div class="row">
            <div class="col-12">
            <a href="service.php" style="text-decoration: none; color:#2b2b2b;">서비스</a> > <a href="estimate.php" style="text-decoration: none; color:#2b2b2b;">비교견적</a>
            </div>
          ...
          <div class="row margin_top_l">
            <div class="col-12 font_size_ll font_weight_b">견적 문의내역</div>
            <div class="col-12">
              <div class="row">
                <div class="col-12 col-sm-4 margin_top_m">
                  <div class="back_w box_shadow padding_l border_radius_m cursor_pointer" >
                    <div class="font_size_l">인테리어</div>
                    <div class="font_weight_b margin_top_s text_align_right"><span class="color_b font_size_xxl"><?php echo $e1?></span><span class="margin_left_m">건</span></div>
                  </div>
                </div>
                <div class="col-12 col-sm-4 margin_top_m">
                  <div class="back_w box_shadow padding_l border_radius_m cursor_pointer" >
                    <div class="font_size_l">마케팅</div>
                    <div class="font_weight_b margin_top_s text_align_right"><span class="color_b font_size_xxl"><?php echo $e2?></span><span class="margin_left_m">건</span></div>
                  </div>
                </div>
                <div class="col-12 col-sm-4 margin_top_m">
                  <div class="back_w box_shadow padding_l border_radius_m cursor_pointer" >
                    <div class="font_size_l">홈페이지</div>
                    <div class="font_weight_b margin_top_s text_align_right"><span class="color_b font_size_xxl"><?php echo $e3?></span><span class="margin_left_m">건</span></div>
                  </div>
                </div>
                <div class="col-12 col-sm-4 margin_top_m">
                  <div class="back_w box_shadow padding_l border_radius_m cursor_pointer" >
                    <div class="font_size_l">자금대출</div>
                    <div class="font_weight_b margin_top_s text_align_right"><span class="color_b font_size_xxl"><?php echo $e4?></span><span class="margin_left_m">건</span></div>
                  </div>
                </div>
                <div class="col-12 col-sm-4 margin_top_m">
                  <div class="back_w box_shadow padding_l border_radius_m cursor_pointer" >
                    <div class="font_size_l">의료장비</div>
                    <div class="font_weight_b margin_top_s text_align_right"><span class="color_b font_size_xxl"><?php echo $e5?></span><span class="margin_left_m">건</span></div>
                  </div>
                </div>
                <div class="col-12 col-sm-4 margin_top_m">
                  <div class="back_w box_shadow padding_l border_radius_m cursor_pointer" >
                    <div class="font_size_l">의료소모품, 세무사 및 기타</div>
                    <div class="font_weight_b margin_top_s text_align_right"><span class="color_b font_size_xxl"><?php echo $e6?></span><span class="margin_left_m">건</span></div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="row margin_top_l">
            <div class="col-12">
              <div class="box_shadow padding_m back_w back_w">
                <div class="container">
                  <div class="row" style="overflow-x: auto;">
                    <div class="col-12">
                      <div class="row justify-content-between align-items-end">
                        <div class="col-6 font_size_ll font_weight_b">견적 문의내역</div>
                        <div class="col-6 col-sm-3">
                          <select class="select_box_ss custom-select year_area padding_s" onchange="estimatePage.selectFilter(this.value,<?php echo $u_id?>)">
                            <option value="all" >전체</option>
                            <option value="1">인테리어</option>
                            <option value="2">마케팅</option>
                            <option value="3">홈페이지</option>
                            <option value="4">자금대출</option>
                            <option value="5">의료장비</option>
                            <option value="6">의료소모품, 세무사 및 기타</option>
                          </select>
                        </div>
                      </div>
                    </div>
                      ...
                      <table>
                        <thead>
                          <tr>
                            ...
                            <th scope="col" class="tablet" style="width: 70px;">번호</th>
                            <th scope="col">분야</th>
                            <th scope="col">일시</th>
                    ...
                    <div class="col-12 margin_top_m">
                      <div class="container">
                        <div class="row justify-content-between align-items-center">
                          <!-- <div class="button6" onclick="estimatePage.deleteList()">
                            선택삭제
                          </div> -->
                          <div>
              ...
              <div class="box_shadow padding_m back_w back_w">
                <div class="container">
                  <div class="row" style="overflow-x: auto;">
                    <div class="col-12">
                      <div class="row justify-content-between align-items-end">
                        <div class="col-6 font_size_ll font_weight_b">받은 견적서</div>
                        <div class="col-6 col-sm-3">
                          <select class="select_box_ss custom-select year_area padding_s" onchange="estimatePage.selectFilter2(this.value,<?php echo $u_id?>)">
                            <option value="all" >전체</option>
                            <option value="1">인테리어</option>
                            <option value="2">마케팅</option>
                            <option value="3">홈페이지</option>
    ...
    <div id="estimate_modal" class="modal" tabindex="-1" role="dialog">
      <div class="padding_l" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <div class="modal-title font_size_l font_weight_b"></div>
                  ...
                  <table>
                    <thead>
                      <tr>
                        ...
                        <th scope="col" class="tablet" style="width: 70px;">번호</th>
                        <th scope="col">업체명</th>
                        <th scope="col">견적서발송일시</th>
                        <th scope="col" style="width: 120px;"></th>
                        <th scope="col" style="width: 100px;"></th>
                      </tr>
                    </thead>
                    <tbody class="estimate_table"></tbody>
                  </table>
                  <div class="margin_top_m">
                    <div class="container">
                      <div class="row justify-content-between align-items-center">
                        <div class="button6" onclick="estimatePage.deleteModalList()">선택삭제</div>
                        <div class="button6" onclick="estimatePage.modal_estimate_table()">더보기</div>
                      </div>
                    </div>
                  </div>
                </div>
    ...
    <script>
      $(document).ready(function () {
        estimatePage.selectFilter('all',<?php echo $u_id?>);
        estimatePage.selectFilter2('all',<?php echo $u_id?>);
      });
    </script>
