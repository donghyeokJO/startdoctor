  ...
  <header>
    ...
    <section class="back_g_l">
      <article class="padding_m">
        <div class="font_size_xl font_weight_b padding_v_l">서비스</div>
        <div>
          <div class="row">
            <form method = "POST" name ="analyform" id = "analyform" action ="http://analysis-web2-dev.ap-northeast-2.elasticbeanstalk.com/user/user_login/">
              <input type = "hidden" name="u_id" value = "<?=$u_id?>"/>
              </form>
            <div class="col-12 col-sm-4 margin_top_m cursor_pointer" >
              <div class="image" style="background-image: url(../assets/service_01.png);height: 335px;" onclick ="location.href='diagnose.php '">
                <div class="color_w font_size_ll" style="background-color: rgba(0,0,0,0.5); height: 100%;">
                  <div class="container" style="height: 100%">
                    <div class="row text_align_center align-items-center" style="height: 100%">
                      <div class="col">개원상권분석</div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-12 col-sm-4 margin_top_m cursor_pointer">
              <div class="image" style="background-image: url(../assets/service_02.png);height: 335px;">
                <div class="color_w font_size_ll" style="background-color: rgba(0,0,0,0.5); height: 100%;">
                  <div class="container" style="height: 100%">
                    <div class="row text_align_center align-items-center" style="height: 100%">
                      <div class="col"><a href = "chat.php" style = "text-decoration:none; color:#FFFFFF">상담채팅</a></div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-12 col-sm-4 margin_top_m cursor_pointer">
              <div class="image" style="background-image: url(../assets/service_03.png);height: 335px;">
                <div class="color_w font_size_ll" style="background-color: rgba(0,0,0,0.5); height: 100%;">
                  <div class="container" style="height: 100%">
                    <div class="row text_align_center align-items-center" style="height: 100%">
                      <div class="col"><a href = "estimate.php" style = "text-decoration:none; color:#FFFFFF">비교견적</a></div>
                    </div>
                  </div>
                </div>
              </div>
