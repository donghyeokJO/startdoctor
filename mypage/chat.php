<?php
  ...
  $u_id = $row['u_id'];
  $u_rank = $row['u_rank'];
  $chat_query = "select * from counsel where u_id = '$u_id'";
  $chat_ret = mysqli_query($conn, $chat_query);
  $chat_num = mysqli_num_rows($chat_ret);
  if ($chat_num == 0) {
      echo "<script> 
              window.alert('현재 채팅이 없습니다. 채팅을 시작해보세요'); 
              window.location.href='../service/chat.php'
            </script> ";
  }
                  ...
                  <div class="row">
                    <div class="col-12">
                      <div class="row justify-content-between align-items-end">
                        <div class="col-6 font_size_ll font_weight_b">문의내용</div>
                        <div class="col-6 col-sm-3">
                          <select class="select_box_ss custom-select year_area padding_s" onchange="chatPage.selectFilter(this.value,<?php echo $u_id?>)">
                      ...
                      <table>
                        <thead>
                          <tr>
                            ...
                            <th scope="col">질문</th>
                            <th scope="col" class="tablet">분야</th>
                    ...
                    <div class="col-12 margin_top_m">
                      <div class="container">
                        <div class="row justify-content-between align-items-center">
                          <!-- <div class="button6" onclick="chatPage.deleteList()">
                            선택삭제
                          </div> -->
                          <div>
                            <!-- <ul id="chat_pagination" class="pagination">
                            </ul> -->
                          </div>
                        </div>
                      </div>
  ...
  <script src="https://code.jquery.com/jquery-3.4.1.min.js" integrity="sha256-CSXorXvZcTkaix6Yvo6HppcZGetbYMGWSFlBw8HfCJo=" crossorigin="anonymous"></script>
    ...
    <script>
      $(document).ready(function () {
        chatPage.selectFilter('all',<?php echo $u_id?>);
      });
    </script>
