    ...
    <section class="back_w position_relative" style="height: calc(100% - 126px);">
        ...
        <div id="chat_list" class="opened">
          <div class="wrap padding_v_s">
            ...
            <?php
               $query = "select * from coach where user2 = '$u_id' order by last desc";
               $ret = mysqli_query($conn, $query);
              ...
              while ($coaches = mysqli_fetch_assoc($ret)) {
                  ...
                  if ($coach_id != $coaches['coach_id']) {
                      echo "
                      <a href = \"chat_list.php?coach_id=$coaches[coach_id]\" style =\"color:#2b2b2b; text-decoration:none\">
                      <div class=\"col-12\" style=\"overflow-x: auto;\">
                      <div class=\"row\" id=\"chat_list_area\"><div class=\"col-12 margin_top_m\"><div class=\"line\"></div></div><div class=\"col-12 margin_top_m cursor_pointer\" onclick=\"location.href='chat_list.php?coach_id=$coach_id'\">
                        <div class=\"container\">    
                          <div class=\"row align-items-center\">      
                            <div class=\"col profile\" style=\"-ms-flex: 0 0 50px;flex: 0 0 50px;background-image: url(../assets/default_profile_company.svg)\"></div>      
                            <div class=\"col\">        
                              <div class=\"font_weight_b\">$corp[u_name]</div>        
                            <div class=\"row\">          
                              <div class=\"col ellipsis color_g font_size_s\">$chat[msg]</div>          
                      ...
                      echo "
                    <div class=\"col-12\" style=\"overflow-x: auto; \">
                    <div class=\"row\" id=\"chat_list_area\"><div class=\"col-12 margin_top_m\"><div class=\"line\"></div></div><div class=\"col-12 margin_top_m cursor_pointer\" style =\"background-color:#b0e0e6\" onclick=\"location.href='chat_list.php?coach_id=$coach_id'\">
                      <div class=\"container\">    
                        <div class=\"row align-items-center\">      
                          <div class=\"col profile\" style=\"-ms-flex: 0 0 50px;flex: 0 0 50px;background-image: url(../assets/default_profile_company.svg)\"></div>      
                          <div class=\"col\">        
                      ...
                      <div class="container">
                        <div class="row align-items-center">
                          ...
                          <div class="margin_left_s" style="max-width: 50%;">
                            <div class="font_weight_b margin_right_s display_inline_block ellipsis" id="chat_detail_name" style="width: 70%;"><?php echo $corp_name?></div>
                            <div class="cursor_pointer font_size_s color_g display_inline_block" onclick="chatListPage.openCompanyDetailModal(<?php echo $u_id1?>);">업체소개보기 ❯</div>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="col-4 text_align_right">
                      <div class="display_inline_block" onclick="chatListPage.hoverLike(<?php echo $u_id2?>,<?php echo $u_id1?>,this)">
                      <?php
                        $query = "select * from star where u_id ='$u_id2' and c_id ='$u_id1'";
                        // echo $query;
                        if (mysqli_num_rows(mysqli_query($conn, $query)) == 0) {
                            ...
                            echo
                            '<svg class="fill_g display_none cursor_pointer" xmlns="http://www.w3.org/2000/svg" width="45" height="45" viewBox="0 0 24 24"><path d="M22 9.24l-7.19-.62L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21 12 17.27 18.18 21l-1.63-7.03L22 9.24zM12 15.4l-3.76 2.27 1-4.28-3.32-2.88 4.38-.38L12 6.1l1.71 4.04 4.38.38-3.32 2.88 1 4.28L12 15.4z"/><path d="M0 0h24v24H0z" fill="none"/></svg>
                            <svg class="fill_y  cursor_pointer" xmlns="http://www.w3.org/2000/svg" width="45" height="45" viewBox="0 0 24 24"><path d="M0 0h24v24H0z" fill="none"/><path d="M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z"/><path d="M0 0h24v24H0z" fill="none"/></svg>';
                        }
                      ?>
                        </div>
