    ...
    <section class="back_g_l">
      <article>
        <div class="container margin_top_l">
          <div class="row">
            <div class="col-12">
             <a href="home.php" style="text-decoration: none; color:#2b2b2b;">마이페이지</a> > <a href="pay.php" style="text-decoration: none; color:#2b2b2b;">결제정보</a> > <a href="change_pay.php" style="text-decoration: none; color:#2b2b2b;">이용권 구매하기</a>
            </div>
      ...
      <article id="article_09">
        <div class="title">서비스 이용 요금</div>
        <div style="font-size:12px;padding:15px">해당 이용권은 구매일로 부터 한 달 이내로 사용이 가능합니다. <br>한달이 경과된 후에는 미사용한 이용권의 기간이 만료되오니 유의하시길 바랍니다.</div>
        <!-- <div class="col-6 input-group margin_top_s">
              <select class="select_box custom-select" name="pay_way" id="pay_way" onchange = "findway()">
                <option value="none">결제수단 선택</option>
                <option value="card">카드</option>
                <option value="phone">휴대폰 소액결제</option>
              </select>
        </div> -->
        <div class="row justify-content-between margin_top_l">
          <div class="col-12 col-md-4" style="padding: 15px;">
            <div class="item" id ="starter" style ="border-top:none;border-radius:35px; text-decoration:none; cursor:pointer">
              <div style ="text-align:center; font-size:22px">
                <b>개원상권분석시스템<br>1회 이용권</b>
                <br><br><span style = "color:#F7A22F; font-size:16px">79,000원</span>
              </div>
            </div>
          </div>
          <div class="col-12 col-md-4" style="padding: 15px;">
            <div class="item" id = "basic" style ="border-top:none;border-radius:35px; text-decoration:none; cursor:pointer">
            <div style ="text-align:center; font-size:22px">
                <b>개원상권분석시스템<br>3회 이용권</b>
                <br><span style="font-size:12px">(약 16% 할인)</span>
                <br><span style = "color:#F7A22F; font-size:16px">198,000원</span>
                
              </div>
            </div>
          </div>
          <div class="col-12 col-md-4" style="padding: 15px;">
            <div class="item" id ="premium" style ="border-top:none;border-radius:35px; cursor:pointer">
              <div style ="text-align:center; font-size:22px">
                <b>개원상권분석시스템<br>5회 이용권</b>
                <br><span style="font-size:12px">(약 25% 할인)</span>
                <br><span style = "color:#F7A22F; font-size:16px">298,000원</span>
            </div>
          </div>
        </div>
        <div class = "col-12" style="padding:15px">
          <div class = "item" style ="border-top:none;border-radius:35px;background-color: #404040;cursor:pointer" onclick ="location.href='https://pf.kakao.com/_xeIrFj'">
            
            <div style ="text-align:center;font-size:24px;color:#e4ca4e"><b>개원상권분석시스템 프로 서비스</b></div>
            <br>
            <div style ="text-align:center;font-size:18px;color:#FFFFFF;font-weight:lighter">개원상권분석시스템 프로 서비스는 1:1로 상담을 진행한후</div>
         
            <div style ="text-align:center;font-size:18px;color:#FFFFFF;font-weight:lighter">커스터마이징 상권 분석을 제공하는 서비스 입니다.</div>
           
            <br>
            <div style ="text-align:center;font-size:18px;color:#FFFFFF"><b>가격 별도 문의</b></div>
          </div>
        </div>
      </article>
    </section>
