<?php
  ...
  if (!isset($_SESSION['u_email'])) {
      ...
      $fid = $_GET['id'];
      $query = "select * from $form where fid ='$fid'";
      $temp = mysqli_query($conn, $query);
      $form = mysqli_fetch_array($temp);
      $doc_id = $form['u_id'];

      $query = "select * from user where u_id ='$doc_id'";
      $utemp = mysqli_query($conn, $query);
      $doctor = mysqli_fetch_array($utemp);
      $doc_name = $doctor['u_name'];
  }
        ...
        <div class="row justify-content-center">
          <div class="col-12 col-sm-10 cursor_pointer">
            <div class="row justify-content-center align-items-end" style="height: 40px;">
              ...
              <div class="col"><a href ="service_corp.php" style="color:#FFFFFF; text-decoration:none">비교견적</a><div class="line_b" style="border-width: 5px;"></div></div>
    ...
    <section class="back_g_l">
      <article>
        ...
        <div class="container margin_top_l">
          <div class="row">
            <div class="col-12">
              <div class="container back_w">
                <div class="row">
                  <div class="col-12 padding_v_m font_size_ll font_weight_b"><?php echo $doc_name?><span class="color_g">님</span></div>
              ...
              if ($tap == '인테리어') {
                  echo "
              <div class=\"container back_w padding_v_l\">
                <div class=\"row\">
                  ...
                  <div class=\"col-12 font_weight_b margin_top_l\">
                    2. 인테리어 받을 곳의 주소를 입력해주세요.
                  </div>
                  <div class=\"col-12 margin_top_m font_size_s\">
                    $form[f1_address]
                  </div>
                ...
                <div class=\"container back_w padding_v_l\">
                  <div class=\"row\">
                    ...
                    <div class=\"col-12 font_weight_b margin_top_l\">
                      4. 원하는 광고 종류를 선택해주세요. (오프라인 마케팅 , 온라인 마케팅 , 모두)
                    </div>
                    <div class=\"col-12 margin_top_m font_size_s\">
                      $form[f2_type]
                    </div>
                ...
                <div class=\"container back_w padding_v_l\">
                  <div class=\"row\">
                    ...
                    <div class=\"col-12 font_weight_b margin_top_l\">
                      2. 대출이 필요한 금액을 입력해주세요.
                    </div>
                    <div class=\"col-12 margin_top_m font_size_s\">
                      $form[f4_money]
                    </div>
                    <div class=\"col-12 font_weight_b margin_top_l\">
                      3. 재직형태를 선택해주세요. (개원의사/개원예정의사/봉직의사/기타)
                    </div>
                    <div class=\"col-12 margin_top_m font_size_s\">
                      $form[f4_type]
                    </div>
                ...
                <div class=\"container back_w padding_v_l\">
                  <div class=\"row\">
                    ...
                    <div class=\"col-12 font_weight_b margin_top_l\">
                      2. 필요한 의료장비 이름을 입력해주세요.
                      (여러개일 경우 모델명과 장비명을 모두 적어주세요)                      
                    </div>
                    <div class=\"col-12 margin_top_m font_size_s\">
                      $form[f5_all]
                    </div>
                ...
                <div class=\"container back_w padding_v_l\">
                  <div class=\"row\">
                    ...
                    <div class=\"col-12 font_weight_b margin_top_l\">
                      2.원하시는 서비스/상품의 종류를 선택해주세요 
                      -의약품/소모품 , 배상책임보험, 간판,
                      전자차트, 보안시설, 로고제작, 세무사, 부동산,
                      기타 (직접입력).
                    </div>
                    <div class=\"col-12 margin_top_m font_size_s\">
                      $form[f6_type]
            ...
            <form method = "POST" action = "form_answer.php" id = "answer_form" enctype="multipart/form-data">
            ...
            <div class="col-12 margin_top_s" style="width:100%">
              <textarea class="form-control" rows="8" cols="200" name = "content" placeholder="간단한 내용을 적어주세요. 견적서 첨부는 잊지말아주세요!"></textarea>
            </div>
          </div>
    
            <div class="row justify-content-center align-items-center">
              <div class="col-12 col-sm-10 margin_top_s">
                <input id="estiamte_detail_file" type="file" name="file" onchange = "javascript: document.getElementById('estiamte_detail_file_text').value=this.value.split('\\')[this.value.split('\\').length-1]"/>
                <div class="row">
                  <div class="col-5"><label class="button6" for="estiamte_detail_file" style="margin: 0;width: 100%;" >파일 선택</label></div>
                  
                  <div class="col-7 col-sm-5" style ="height:30px"><input type="text" id="estiamte_detail_file_text" class="border_g back_w"  name = "filename" style="width: 100%; height:30px;"></div>
                </div>
              </div>
              <div class="col-6  col-sm-2 margin_top_s">
                <div class="button small" style="background-color: #000;" onclick = "$('#answer_form').submit()">전송하기 ❯</div>
              </div>
            </div>
        </div>
      </article>
