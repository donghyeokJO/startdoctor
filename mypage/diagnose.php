<?php
  ...
  try {
      ...
      $query = "select * from user_view  where u_id = $u_id order by used_id desc limit $limit offset $offset";
...
(function(w, d, a){
  ...
  <div class="ploting_banner" onclick="location.href='https://pf.kakao.com/_xeIrFj'">
    ...
    <section class="back_g_l">
      <article>
        <div class="container margin_top_l">
          <div class="row">
            <div class="col-12">
             <a href="service.php" style="text-decoration: none; color:#2b2b2b;">서비스</a> > <a href="diagnose.php" style="text-decoration: none; color:#2b2b2b;">개원상권분석</a>
            </div>
          ...
          <div class="row margin_top_m">
            <div class="col-12">
              <div id="diagnose_tab" class="tab3">
                <div class="tab_item" >프리미엄정보</div>
                
                <div class="line position_relative" style="top: -1px;"></div>
              </div>
            </div>
          </div>
                  ...
                  <div class="row">
                      ...
                      <table>
                        <thead>
                          <tr>
                            ...
                            <th scope="col">진료과</th>
                            <th scope="col">주소</th>
                            <th scope="col" class="tablet">일시</th>
                        ...
                        while ($row = mysqli_fetch_array($ret)) {
                            $form_id = 'form' . $i;
                            echo"
                            <form id = \"$form_id\" method  = \"POST\" action = \" http://analysis-web2-dev.ap-northeast-2.elasticbeanstalk.com/salesview/ \">
                              ...
                              <input type = \"hidden\" name = \"place\" value = \"$row[juso]\"/>
                            </form>
                          <tr>
                            <td class=\"text_align_right\"></td>
                            <td class=\"text_align_center tablet\">$i</td>
                            <td class=\"text_align_center\">$row[subject]</td>
                            <td><div onclick = 'gotosales($i)'>$row[juso]</div><div class=\"color_g margin_top_ss mobile\">$row[date]</div></td>
                    ...
                    if (mysqli_num_rows($ret) == 0) {
                      ...
                      <div class="row align-items-center justify-content-center" >
                        <div class="col-12 text_align_center color_b font_size_l" style ="width:300px"><br><br>결제내역이 없습니다 :)<br><br><br></div>
                      </div>
                    ...
                    <div class="col-12 margin_top_m">
                      <div class="container">
                        <div class="row justify-content-between align-items-center">
                          ...
                          <div>
                            <?php echo '<div id="paging"><p>', $prevlink, ' 현재 ', $page, ' 총 ', $pages, ' 페이지 ', $nextlink, ' </p></div>';?>
                          </div>
                        </div>
                      </div>
                    </div>
    ...
    <script>
      function gotosales(form_num) {
        $('#form'+form_num).submit()
      }
    </script>
