var chatManager = new function () {
	...
	this.write = function (frm) {
		...
		var user1 = frm.u_id1.value;
		var user2 = frm.u_id2.value;
		...
		// POST Parameter 구축
		param.push("u_id1=" + encodeURIComponent(user1));
		param.push("u_id2=" + encodeURIComponent(user2));
		param.push("coach_id=" + encodeURIComponent(coach_id));
