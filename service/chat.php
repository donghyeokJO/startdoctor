      ...
      <article>
        <div class="container margin_top_xl">
          <div class="row justify-content-end">
            <div class="col-12"><a href="../main/index.php" style="text-decoration: none; color: #2b2b2b;">HOME</a> > <a href="chat.php" style="text-decoration: none; color: #2b2b2b;">상담채팅</a></div>
          </div>
                ...
                echo'
                  <div class="row justify-content-center">
                    <div class="col-12 col-sm-3">
                      <div class="button margin_top_l" style="height: 38px;font-size: 14px;"><a href="chat_info.php" style="color:#FFFFFF;text-decoration:none; width: 100%; height: 38px; line-height: 38px; text-align: center;">질문 전달하기 ></a></div>
                    </div>
                  </div>';
            } else {
                echo'
                  <div class="row justify-content-center">
                    <div class="col-12 col-sm-3">
                      <div class="button margin_top_l" style="height: 38px;font-size: 14px;"><a href="#" style="color:#FFFFFF; width: 100%; height: 38px; line-height: 38px; text-align: center;" onclick="window.open(\'signin.html\',\'sign_in\',\'width=400,height=600,left=100,top=50\')">질문 하기 ></a></div>
                    </div>
                  </div>';
            }
          ?>
