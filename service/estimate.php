    ...
    <section class="back_g_l" style="min-height: 100vh;">
      <article>
        <div class="container margin_top_xl">
          <div class="row justify-content-end">
            <div class="col-12"><a href="../main/index.php" style="text-decoration: none; color: #2b2b2b;">HOME</a> > <a href="estimate.php" style="text-decoration: none; color: #2b2b2b;">비교견적</a></div>
          </div>
        </div>
      </article>
      ...
      <article>
        ...
        <div class="container back_w">
          ...
          <div class="item scroll_event active row margin_top_xl align-items-center">
            <div class="col-12">
              <div class="container back_w">
                <div class="row padding_v_l margin_top_xl">
                  <div class="col-12 text_align_center font_size_xl font_weight_b">업체비교, 이제 한번에 하세요!</div>
                  <div class="col-12 text_align_center margin_top_l">한 번의 문의로 진료과목, 지역, 컨셉 및 자금현황 등 개인별 맞춤형 견적서를 수령 및 비교해볼 수 있는 서비스입니다.</div>
                  <!-- <div class="col-12 margin_top_l text_align_center">
                    <div class="image" style="height: 50vh; background-image: url(https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTx52MOwCvPc6SkXtwMCHaIWo8nLNaC9_hPCJ5xmtl2lDFDJdNe)"></div>
                  </div> -->
                </div>          
                    <?php
                      if ($login) {
                          echo'
                            <div class="row margin_top_m justify-content-center">
                            <div class="col-10 col-sm-4 button" style="height: 53px;font-size: 18px"><a href="estimate_detail.php " style = "color:#FFFFFF; text-decoration:none; width: 100%; height: 38px; line-height: 38px; text-align: center;">견적신청 진행하기 ❯</a></div>
                          </div>';
                      } else {
                          echo'
                            <div class="row margin_top_m justify-content-center">
                                <div class="col-10 col-sm-4 button" style="height: 53px;font-size: 18px"><a href="#" style="color:#FFFFFF; width: 100%; height: 38px; line-height: 38px; text-align: center;" onclick="window.open(\'signin.html\',\'sign_in\',\'width=400,height=600,left=100,top=50\')">견적신청 진행하기 ></a></div>
                              </div>';
                      }
                    ?>
