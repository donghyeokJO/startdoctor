<?php
  ...
  $page_num = $no * 10;
  $query = "select * from notice order by n_no limit $page_num,$page_size";
  $ret = mysqli_query($conn, $query);
  $curr = mysqli_num_rows($ret);
  ...
  if ($total % 10 == 0) {
      ...
      $total_page = floor($total / $page_size) + 1;
  }
  session_start();
  $login = false;
      ...
      <article>
        <div class="container margin_top_xl">
          <div class="row justify-content-end">
            <div class="col-12"><a href="../main/index.php" style="text-decoration: none; color:#2b2b2b;">HOME</a> > <a href="notice.php" style="text-decoration: none; color:#2b2b2b;">공지사항</div>
            ...
            <div class="col-12 margin_top_m">
              <table class="back_w" style="border-bottom: 1px solid #2b2b2b;">
                <thead>
                  <tr>
                    <th class="tablet" style="width: 60px;">No</th>
                    <th>제목</th>
                    <th style="width: 120px;">작성날짜</th>
                    <th class="tablet" style="width: 80px">조회수</th>
                  </tr>
                </thead>
                <tbody>
                  <?php
                    while ($row = mysqli_fetch_array($res)) {
                        echo "<tr>
                      <th class=\"tablet\">$row[n_no]</th>
                      <td><a href=\"detail.php?n_no=$row[n_no]\" style = \"color:#2B2B2B\">$row[n_title]</a></td>
                      <td class=\"text_align_center\">$row[n_date]</td>
                      <td class=\"tablet text_align_center\">$row[n_hit]</td>
                    </tr>";
                    }
...
<!-- 
            <div class="col-12 text_align_right margin_top_m margin_right_s cursor_pointer">
              <span class="margin_left_s color_b">1</span>
              <span class="margin_left_s">2</span>
              <span class="margin_left_s">3</span>
              <span class="margin_left_s">4</span>
              <span class="margin_left_s">5</span>
              <span class="margin_left_s">></span>
            </div> -->
