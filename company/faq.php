      ...
      <article>
        <div class="container">
          <div class="row align-items-center header_title_height">
            <div class="col-12 text_align_center color_w font_size_xl font_weight_b">FAQ</div>
          </div>
        </div>
      </article>
    </section>
      ...
      <article>
        <div class="container margin_top_xl">
          <div class="row justify-content-end">
            <div class="col-12"><a href="../main/index.php" style="text-decoration: none; color:#2b2b2b;">HOME</a> > <a href="faq.php" style="text-decoration: none; color:#2b2b2b;">FAQ</a></div>
            <!-- <div class="col-12 col-sm-4 position_relative margin_top_s">
              <input name="" class="search" placeholder="Search" style="width: 100%;"/>
              <svg class="position_absolute" style="left: 20px;top: 8px;" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M15.5 14h-.79l-.28-.27C15.41 12.59 16 11.11 16 9.5 16 5.91 13.09 3 9.5 3S3 5.91 3 9.5 5.91 16 9.5 16c1.61 0 3.09-.59 4.23-1.57l.27.28v.79l5 4.99L20.49 19l-4.99-5zm-6 0C7.01 14 5 11.99 5 9.5S7.01 5 9.5 5 14 7.01 14 9.5 11.99 14 9.5 14z"/><path d="M0 0h24v24H0z" fill="none"/></svg>
            </div> -->
            
            <div class="col-12 margin_top_m">
              <?php
                  while ($row = mysqli_fetch_array(mysqli_fetch_array(mysqli_query($conn, 'select * from faq')))) {
                      echo "
                      <div class=\"faq_area\">
                      <table class=\"back_w\">
                        </tbody>  
                          <tr>
                            <th onclick=\"hoverFaq(this);\" class=\"color_b\" style=\"width: 80px;\">Q</th>
                            <td onclick=\"hoverFaq(this);\">$row[f_title]</td>
                            <td onclick=\"hoverFaq(this);\" class=\"tablet text_align_center\" style=\"width: 120px;\">$row[date]</td>
                            <td onclick=\"hoverFaq(this);\" class=\"text_align_center\" style=\"width: 80px;\">
                              <svg class=\"arrow\" xmlns=\"http://www.w3.org/2000/svg\" width=\"30\" height=\"30\" viewBox=\"0 0 24 24\"><path d=\"M7.41 8.59L12 13.17l4.59-4.58L18 10l-6 6-6-6 1.41-1.41z\"/><path fill=\"none\" d=\"M0 0h24v24H0V0z\"/></svg>
                            </td>
                          </tr>
                        </tbody>
                      </table>
                      <div class=\"faq_result\" style=\"display: none;\">
                       
                        <div class=\"padding_l\" style=\"border-bottom: 1px solid #2b2b2b;border-top: 1px solid #2b2b2b;\">
                        <div class=\"font_size_l\">■ $row[f_title]</div>
                          <div>"?> <?php echo nl2br($row['f_content']); ?> 
                          <?php echo'</div>
                        </div>
                      </div>
                    </div>';
